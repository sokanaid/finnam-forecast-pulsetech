...
**Котировки** (train):
- OHLCV данные: 24,197 строк
- 19 тикеров: SBER, GAZP, LKOH, NVTK, ROSN, SIBN, GMKN, ALRS, MAGN, CHMF, MTSS, AFLT, PHOR, MOEX, VTBR, RUAL, PLZL, MGNT, T
- Период: 2020-2025 (5 лет)

**Новости** (train):
- 25,425 новостей с заголовками + текстом
- Извлечение тикеров: 96% покрытие
- Период: 2020-2025
...
| **Качество** | 2,845 предсказаний, 19 тикеров | ✅ **Идеальная калибровка** |
